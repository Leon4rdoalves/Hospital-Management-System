...
def PAT():
    ...
    nasc = tkinter.Label(rootpaciente, text="Data de Nasc.: ", font='Ubuntu 12', fg='gray')
    pat_NASC = tkinter.Entry(rootpaciente, width=15)
    nasc.place(x=25, y=135)
    pat_NASC.place(x=140, y=135)

    sexo = tkinter.Label(rootpaciente, text="Sexo:", font='Ubuntu 12', fg='gray')
    masc = tkinter.Radiobutton(rootpaciente, variable='pat_sexo_masc', text='M', value='M', fg='gray', font='Ubuntu 12')
    femi = tkinter.Radiobutton(rootpaciente, variable='pat_sexo_femi', text='F', value='F', fg='gray', font='Ubuntu 12')
    sexo.place(x=300, y=135)
    masc.place(x=341, y=135)
    femi.place(x=390, y=135)
